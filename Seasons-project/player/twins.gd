...
func _update_distance():
	...
	#self._player_left.set_direction_to_twin(self._player_right.global_position - self._player_left.global_position)
	self._player_right.set_direction_to_twin((self._player_left.global_position - self._player_right.global_position).normalized())
	#print(self._player_right.get_direction_to_twin())